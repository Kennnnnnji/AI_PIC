package buaa.android.aipic.share.imgur;

import static buaa.android.aipic.utilities.Constants.IMGUR_LOGIN_URL;
...
public class ImgurAuthActivity extends ThemedActivity {
  private static final String REDIRECT_URL = "https://buaa.android.aipic";
